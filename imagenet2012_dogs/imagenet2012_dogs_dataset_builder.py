...
from tensorflow_datasets.datasets.imagenet2012.imagenet2012_dataset_builder import _add_split_if_exists
...
class Builder(Imagenet2012Builder):
    ...
    def _generate_examples(
        ...
        if validation_labels is None and labels_exist:
            gen_fn = self._filtered_generate_examples(archive, perc=build_config.nondog_perc / 100.0, seed=self.SEED)
            ...
            for key, example in gen_fn:
                ...
                if labels_exist and build_config.nondog_perc != 100 and nondog_downsampler.filter(
                    example
                ):
                    continue
    ...
    def _filtered_generate_examples(self, archive, perc: float, seed: int):
        ...
        for fname, fobj in archive:
            ...
            if is_dog:
                ...
                includes = np.random.binomial(1, perc, size=MAX_EXAMPLES_PER_CLASS)
